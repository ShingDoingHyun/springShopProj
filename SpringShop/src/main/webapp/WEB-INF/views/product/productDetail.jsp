...
<div class="shell">
  ...
  <div id="main">
	...
	<td class="name"><span style="font-size:14px;color:#000000;">${productDTO.productName }</span><br/><br/>
	</td>
	</tr>
	<tr class=" xans-record-">
	<td>
	<b><span style="font-size:12px;color:#000000;">PRICE</span></b> <span style="font-size:12px;color:#000000;"><strong id="span_product_price_text">KRW ${productDTO.productPrice }</strong><input id="product_price" name="product_price" value="" type="hidden" /></span></td>
	</tr>
	<tr class=" xans-record-">
	<td>
	<b><span style="font-size:12px;color:#000000;">POINT</span></b> <span style="font-size:12px;color:#000000;"><span id="span_mileage_text">${productDTO.productPrice/100 }원 (1%)</p></span></td>
	</tr>
	...
	<li>
	<a>INSTRUCTION</a>
	<div class="tab_wrap"><pre>${productDTO.productDetail }</pre></div>
	</li>
